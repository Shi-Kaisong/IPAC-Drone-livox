...
public:
  ...
  static constexpr double POSITION_CTRL_VALUE = 0.75;
...
public:
  ...
  Odom_Data_t();
  void feed(nav_msgs::OdometryConstPtr pMsg, Imu_Data_t *imu_data);
};
